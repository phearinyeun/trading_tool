    ...
    try:
        with open(file_path, "r") as f:
            ...
            if isinstance(data, list):
                ...
                raise ValueError("symbols_config.json has invalid format")
...
# ===========================
# 6️⃣ Main Loop: 10-Minute Signals (with 5-min TV interval)
# ===========================
def main():
    ...
    while True:
        ...
        for symbol, config in symbols_config.items():
            try:
                ...
                time.sleep(5)  # small delay between symbols to reduce 429
